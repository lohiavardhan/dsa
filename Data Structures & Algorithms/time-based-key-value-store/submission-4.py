class TimeMap:
    ...
    def get(self, key: str, timestamp: int) -> str:
        ...
        print(mid, search_space[mid][0][1], timestamp, search_space[mid][1])
        if mid > 0 and timestamp < search_space[mid][0][1]:
            mid -= 1
        else:
            while mid < len(search_space) - 1 and timestamp > search_space[mid][0][1]:
                mid += 1
